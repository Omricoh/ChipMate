...
class TestAdminAccess:
    ...
    def test_list_games_without_admin_env(self, games_dal):
    ...
    def test_list_games_with_admin_auth(self, games_dal, monkeypatch):
    ...
    def test_admin_access_isolation(self, games_dal):
